...
#calculating the GAM
library(mgcv)
mod_lm = gam(value ~ Pop, data = locus_table_SY_hexp_pivot)
summary(mod_lm)
mod_gam1 = gam(value ~ s(Pop), data = locus_table_SY_hexp_pivot)
summary(mod_gam1)
mod_gam2 = gam(value ~ s(Pop) + s(SamplingYear) + s(locus), data = locus_table_SY_hexp_pivot)
summary(mod_gam2)
```
