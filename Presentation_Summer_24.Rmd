...
```{r Hexp table Pop TruffleYear without empty facets, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r rarefy Nei TruffleYear without BAR and SCHIF, echo=TRUE, warning=FALSE}
setPop(myData_genind_allMarkersOnly_allButBAR_SCHIF) <- ~Pop/TruffleYear
...
```{r cc Hexp table Pop TruffleYear removed BAR SCHIF GEN, echo=TRUE, warning=FALSE, message=FALSE}
setPop(cc_myData_genind_allMarkersOnly_SY) <- ~Pop
