...
rm(cc_myData_genind_allMarkersOnly)
...
```{r cc Hexp table Pop SamplingYear, echo=TRUE, warning=FALSE, message=FALSE}
...
```{r cc Hexp table Pop TruffleYear, echo=TRUE, warning=FALSE, message=FALSE}
